defmodule WildPalmsIoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WildPalmsIoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WildPalmsIoWeb.Gettext, "errors", msg, opts)
    end
  end
